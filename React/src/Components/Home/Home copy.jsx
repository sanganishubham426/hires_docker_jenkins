      ...
      <div className="grid grid-cols-12 gap-6 mt-5">
        ...
        <div className="col-span-12 md:col-span-6 xl:col-span-4 order-3">
          <Card className="h-full w-full p-4">
            ...
            <div className="grid grid-cols-2 border rounded-lg mt-2">
              {/* Female */}
                    ...
                    return (
                      <>
                        <tr key={index} className="">
                          <td className="border-b border-e py-3 ps-2 w-full flex items-center">
                ...
                <tbody>
                  {Males.slice(0, 4).map((item, index) => {
                    return (
                      <>
                        <tr key={index} className="">
                          <td className="border-b py-3 ps-2 w-full flex items-center ">
